...
if($_SERVER['REQUEST_METHOD']=== 'POST'){
      ...
      if($img_size < 100000000){
        if($post_one !="" && $photo !=""){
          $foder = "img/". $photo;
          move_uploaded_file($temp_name,$foder);
              $sql = "insert into phot(post,imag) values('$post_one','$photo')";
          ...
          $res = mysqli_query($conn,$sql);
          if($res){
              //echo "sefull text only";
              header("location:homeEdit22.php");
          }


        }else{
          $er = "please isert phot or text";
        }

      }else{
          $er = "Image size is too large";
      }
}
...
<div class="container">
     ...
     <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p class="text-danger"> <?php echo $er;?></p>
     </form>
